...
public class Banco {
	...
	public static void main(String args[]) {
		...
		System.out.println("Ap�s o credito de R$ 1000,00, a conta n�mero " + c1.getNumero() + " passou a ter saldo "
				+ c1.getSaldo());

		c1.debitar(100);

		System.out.println("Ap�s o d�bito de R$ 100,00, a conta n�mero " + c1.getNumero() + " passou a ter saldo "
				+ c1.getSaldo());
		...
		System.out.println(
				"A conta n�mero " + c2.getNumero() + " possui saldo " + c2.getSaldo() + " Ap�s d�bito de R$ 500");

		// c1.creditar(1000);

		System.out.println("A conta n�mero " + c2.getNumero() + " possui saldo " + c2.getSaldo() + " e Limite de "
				+ c2.getLimite());

		c2.setLimite(10000);

		System.out.println("A conta n�mero " + c2.getNumero() + " possui saldo " + c2.getSaldo() + " e novo Limite de "
				+ c2.getLimite());
